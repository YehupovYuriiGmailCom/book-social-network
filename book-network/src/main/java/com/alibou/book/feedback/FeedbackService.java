...
public class FeedbackService {
    ...
    public Integer save(final FeedbackRequest request, final Authentication connectedUser) {
    ...
    public PageResponse<FeedbackResponse> findAllFeedbacksByBook(final Integer bookId, final int page, final int size, final Authentication connectedUser) {
