...
import { findAllBorrowebBooks } from '../fn/book/find-all-borroweb-books';
import { FindAllBorrowebBooks$Params } from '../fn/book/find-all-borroweb-books';
...
export class BookService extends BaseService {
  ...
  approveReturnBorrowedBook$Response(params: ApproveReturnBorrowedBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    const obs = approveReturnBorrowedBook(this.http, this.rootUrl, params, context);
    return obs;
  }
  ...
  approveReturnBorrowedBook(params: ApproveReturnBorrowedBook$Params, context?: HttpContext): Observable<number> {
    const resp = this.approveReturnBorrowedBook$Response(params, context);
    return resp.pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
  ...
  /** Path part for operation `findAllBorrowebBooks()` */
  static readonly FindAllBorrowebBooksPath = '/books/borrowed';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllBorrowebBooks()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllBorrowebBooks$Response(params?: FindAllBorrowebBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
    const obs = findAllBorrowebBooks(this.http, this.rootUrl, params, context);
    return obs;
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllBorrowebBooks$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllBorrowebBooks(params?: FindAllBorrowebBooks$Params, context?: HttpContext): Observable<PageResponseBorrowedBookResponse> {
    const resp = this.findAllBorrowebBooks$Response(params, context);
    return resp.pipe(
      map((r: StrictHttpResponse<PageResponseBorrowedBookResponse>): PageResponseBorrowedBookResponse => r.body)
    );
  }
